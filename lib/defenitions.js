...
const defenitions = [
  ...
  {name: 'delete', alias: 'd', type: String, description: 'Starts the process of deleting the script or schedule. Possible values (script | schedule)'},
  ...
  {name: 'deattach', alias: 'D', type: Boolean, description: 'Run scripterra worker in background'},
